...
'use strict';
/*
 * unicorn-high-ticket-offer-router
 * ----------
 * Unicorn High-Ticket Offer Router
 * Domain: high-ticket-offers
 *
 * Routes high-ticket buyer intent to billion-scale packages and BTC checkout.
 *
...
const NAME   = 'unicorn-high-ticket-offer-router';
const TITLE  = 'Unicorn High-Ticket Offer Router';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Routes high-ticket buyer intent to billion-scale packages and BTC checkout.`,
