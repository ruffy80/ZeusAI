...
'use strict';
/*
 * unicorn-gmv-take-rate-router
 * ----------
 * Unicorn GMV Take-Rate Router
 * Domain: marketplace
 *
 * Computes platform fee + vendor split + affiliate commission for marketplace GMV.
 *
...
const NAME   = 'unicorn-gmv-take-rate-router';
const TITLE  = 'Unicorn GMV Take-Rate Router';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Computes platform fee + vendor split + affiliate commission for marketplace GMV.`,
