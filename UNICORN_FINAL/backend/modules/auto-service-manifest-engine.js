 ...
 * Domain: delivery
 *
 * Compiles service-manifest.json from registry + pricing + KPI metadata.
 *
...
const NAME   = 'auto-service-manifest-engine';
const TITLE  = 'Auto Service Manifest Engine';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Compiles service-manifest.json from registry + pricing + KPI metadata.`,
