...
'use strict';
/*
 * unicorn-enterprise-delivery-router
 * ----------
 * Unicorn Enterprise Delivery Router
 * Domain: delivery
 *
 * Routes paid enterprise offers to SaaS / API / tenant / private-deployment delivery modes.
 *
...
const NAME   = 'unicorn-enterprise-delivery-router';
const TITLE  = 'Unicorn Enterprise Delivery Router';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Routes paid enterprise offers to SaaS / API / tenant / private-deployment delivery modes.`,
