 ...
 * Domain: growth
 *
 * Generates vertical growth pages with SEO + JSON-LD + lead capture.
 *
...
const TITLE  = 'Vertical Growth Page Engine';
const DOMAIN = 'growth';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Generates vertical growth pages with SEO + JSON-LD + lead capture.`,
