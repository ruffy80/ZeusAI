 ...
 *
 * Negotiates objections and proposes BTC-direct enterprise close steps.
 *
...
const TITLE  = 'AI Sales Closer Pro';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Negotiates objections and proposes BTC-direct enterprise close steps.`,
