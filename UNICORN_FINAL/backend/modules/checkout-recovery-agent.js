 ...
 *
 * Detects abandoned checkouts and triggers recovery sequences (email/SMS/incentive).
 *
...
const TITLE  = 'Checkout Recovery Agent';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Detects abandoned checkouts and triggers recovery sequences (email/SMS/incentive).`,
