...
function process(input = {}) {
  ...
  return { success: true, module: 'AdaptiveModule15', cycles: state.cycles, processed: input };
}

function getStatus() {
  return { module: 'AdaptiveModule15', active: state.active, cycles: state.cycles, lastRun: state.lastRun };
}
