 ...
 * Domain: strategy
 *
 * Maintains a backlog of future inventions linked to capabilities and TAM.
 *
...
const NAME   = 'future-invention-foundry';
const TITLE  = 'Future Invention Foundry';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Maintains a backlog of future inventions linked to capabilities and TAM.`,
