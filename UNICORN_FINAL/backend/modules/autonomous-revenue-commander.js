 ...
 *
 * Allocates pipeline focus across SDR/closer/upsell loops based on conversion telemetry.
 *
...
const NAME   = 'autonomous-revenue-commander';
const TITLE  = 'Autonomous Revenue Commander';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Allocates pipeline focus across SDR/closer/upsell loops based on conversion telemetry.`,
