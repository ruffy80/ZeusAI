 ...
 * Domain: growth
 *
 * Creates vertical demand pages and commercial activation plans for enterprise acquisition.
 *
...
const NAME   = 'unicorn-vertical-demand-engine';
const TITLE  = 'Unicorn Vertical Demand Engine';
const DOMAIN = 'growth';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Creates vertical demand pages and commercial activation plans for enterprise acquisition.`,
