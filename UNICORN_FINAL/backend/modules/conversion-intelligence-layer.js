 ...
 *
 * Scores landing-page visitors, ranks intent and triggers automated playbooks.
 *
...
const TITLE  = 'Conversion Intelligence Layer';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Scores landing-page visitors, ranks intent and triggers automated playbooks.`,
