 ...
 * Domain: proof-kpi
 *
 * Aggregates ARR, MRR, BTC payouts, GMV, margin and pipeline into a single owner snapshot.
 *
...
const TITLE  = 'Owner Revenue Dashboard';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Aggregates ARR, MRR, BTC payouts, GMV, margin and pipeline into a single owner snapshot.`,
