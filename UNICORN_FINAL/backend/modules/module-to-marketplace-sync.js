 ...
 * Domain: marketplace
 *
 * Syncs Unicorn module inventory with serviceMarketplace and globalMonetizationMesh listings.
 *
...
const NAME   = 'module-to-marketplace-sync';
const TITLE  = 'Module to Marketplace Sync';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Syncs Unicorn module inventory with serviceMarketplace and globalMonetizationMesh listings.`,
