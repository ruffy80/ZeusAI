...
'use strict';
/*
 * unicorn-owner-payout-sentinel
 * ----------
 * Unicorn Owner Payout Sentinel
 * Domain: btc-settlement
 *
 * Asserts that every booked revenue event is routed to LEGAL_OWNER_BTC.
 *
...
const NAME   = 'unicorn-owner-payout-sentinel';
const TITLE  = 'Unicorn Owner Payout Sentinel';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Asserts that every booked revenue event is routed to LEGAL_OWNER_BTC.`,
