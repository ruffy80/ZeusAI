 ...
 *
 * Generates productized offers (priceUsd, kpi, deliverable, guardrails) from capability inputs.
 *
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Generates productized offers (priceUsd, kpi, deliverable, guardrails) from capability inputs.`,
