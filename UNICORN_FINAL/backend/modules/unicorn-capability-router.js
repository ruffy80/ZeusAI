 ...
 *
 * Routes a capability request to existing modules first and only falls back to generated control modules when needed.
 *
...
const NAME   = 'unicorn-capability-router';
const TITLE  = 'Unicorn Capability Router';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Routes a capability request to existing modules first and only falls back to generated control modules when needed.`,
