 ...
 * Domain: proof-kpi
 *
 * Turns delivery metrics into proof assets, ROI baselines and enterprise case-study evidence.
 *
...
const NAME   = 'unicorn-case-study-proof-engine';
const TITLE  = 'Unicorn Case Study Proof Engine';
const DOMAIN = 'proof-kpi';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Turns delivery metrics into proof assets, ROI baselines and enterprise case-study evidence.`,
