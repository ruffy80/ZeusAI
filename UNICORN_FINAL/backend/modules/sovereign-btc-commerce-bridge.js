 ...
 *
 * Bridges marketplace, billing and outcome ledgers into BTC-direct payouts to LEGAL_OWNER_BTC.
 *
...
const NAME   = 'sovereign-btc-commerce-bridge';
const TITLE  = 'Sovereign BTC Commerce Bridge';
const DOMAIN = 'btc-settlement';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Bridges marketplace, billing and outcome ledgers into BTC-direct payouts to LEGAL_OWNER_BTC.`,
