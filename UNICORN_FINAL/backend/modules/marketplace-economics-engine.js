 ...
 * Domain: marketplace
 *
 * Calculates GMV, take-rate, vendor split and platform margin for marketplace listings.
 *
...
const NAME   = 'marketplace-economics-engine';
const TITLE  = 'Marketplace Economics Engine';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Calculates GMV, take-rate, vendor split and platform margin for marketplace listings.`,
