 ...
 * Domain: growth
 *
 * Generates vertical SEO templates and demand pages programmatically; complements marketing-innovations/programmatic-seo.
 *
...
const TITLE  = 'Programmatic SEO Engine';
const DOMAIN = 'growth';
...
function getStatus(opts) {
  return {
    ...
    title: TITLE,
    domain: DOMAIN,
    summary: `Generates vertical SEO templates and demand pages programmatically; complements marketing-innovations/programmatic-seo.`,
