...
const ALIASES = {
  ...
  GITHUB_TOKEN: ['GH_PAT', 'GITHUB_TOKEN_SYNC', 'GH_TOKEN'],
  GH_PAT: ['GITHUB_TOKEN', 'GITHUB_TOKEN_SYNC', 'GH_TOKEN'],
  GH_TOKEN: ['GITHUB_TOKEN', 'GH_PAT', 'GITHUB_TOKEN_SYNC'],
  GITHUB_TOKEN_SYNC: ['GITHUB_TOKEN', 'GH_PAT', 'GH_TOKEN'],
  HETZNER_API_KEY: ['HETZNER_API_TOKEN', 'HCLOUD_TOKEN'],
  HETZNER_API_TOKEN: ['HETZNER_API_KEY', 'HCLOUD_TOKEN'],
  HCLOUD_TOKEN: ['HETZNER_API_KEY', 'HETZNER_API_TOKEN'],
  HETZNER_KEY_PATH: ['HETZNER_SSH_KEY_PATH', 'SSH_KEY_PATH'],
  HETZNER_SSH_KEY_PATH: ['HETZNER_KEY_PATH', 'SSH_KEY_PATH'],
  SSH_KEY_PATH: ['HETZNER_SSH_KEY_PATH', 'HETZNER_KEY_PATH'],
  ...
  TELEGRAM_BOT_TOKEN: ['TG_BOT_TOKEN', 'ZAC_TELEGRAM_TOKEN', 'ZEUS_TG_BOT_TOKEN'],
  TG_BOT_TOKEN: ['TELEGRAM_BOT_TOKEN', 'ZAC_TELEGRAM_TOKEN', 'ZEUS_TG_BOT_TOKEN'],
  ZAC_TELEGRAM_TOKEN: ['TELEGRAM_BOT_TOKEN', 'TG_BOT_TOKEN', 'ZEUS_TG_BOT_TOKEN'],
  ZEUS_TG_BOT_TOKEN: ['TELEGRAM_BOT_TOKEN', 'TG_BOT_TOKEN', 'ZAC_TELEGRAM_TOKEN'],
  TELEGRAM_CHAT_ID: ['TG_CHAT_ID', 'ZAC_TELEGRAM_CHAT_ID', 'TELEGRAM_OWNER_CHAT_ID'],
  TG_CHAT_ID: ['TELEGRAM_CHAT_ID', 'ZAC_TELEGRAM_CHAT_ID', 'TELEGRAM_OWNER_CHAT_ID'],
  ZAC_TELEGRAM_CHAT_ID: ['TELEGRAM_CHAT_ID', 'TG_CHAT_ID', 'TELEGRAM_OWNER_CHAT_ID'],
  TELEGRAM_OWNER_CHAT_ID: ['TELEGRAM_CHAT_ID', 'TG_CHAT_ID', 'ZAC_TELEGRAM_CHAT_ID'],
  ZEUS_TG_GROUP_CHAT_ID: ['TELEGRAM_GROUP_CHAT_ID', 'TELEGRAM_CHAT_ID', 'TG_CHAT_ID'],
  TELEGRAM_GROUP_CHAT_ID: ['ZEUS_TG_GROUP_CHAT_ID', 'TELEGRAM_CHAT_ID', 'TG_CHAT_ID'],
  BREVO_API_KEY: ['SENDINBLUE_API_KEY'],
  SENDINBLUE_API_KEY: ['BREVO_API_KEY'],
  DISCORD_WEBHOOK_URL: ['DISCORD_WEBHOOK', 'ZAC_DISCORD_WEBHOOK', 'WATCHDOG_DISCORD_WEBHOOK'],
  DISCORD_WEBHOOK: ['DISCORD_WEBHOOK_URL', 'ZAC_DISCORD_WEBHOOK'],
  ZAC_DISCORD_WEBHOOK: ['DISCORD_WEBHOOK_URL', 'DISCORD_WEBHOOK'],
  GENERIC_WEBHOOK_URL: ['SOCIAL_WEBHOOK_URL', 'WEBHOOK_URL', 'GH_WEBHOOK_URL', 'HETZNER_WEBHOOK_URL'],
  WEBHOOK_URL: ['GENERIC_WEBHOOK_URL', 'SOCIAL_WEBHOOK_URL', 'GH_WEBHOOK_URL'],
  GH_WEBHOOK_URL: ['GENERIC_WEBHOOK_URL', 'WEBHOOK_URL'],
  ...
  FACEBOOK_PAGE_TOKEN: ['FB_PAGE_TOKEN', 'FACEBOOK_ACCESS_TOKEN', 'FB_ACCESS_TOKEN'],
  FACEBOOK_ACCESS_TOKEN: ['FACEBOOK_PAGE_TOKEN', 'FB_PAGE_TOKEN', 'FB_ACCESS_TOKEN'],
  FACEBOOK_PAGE_ID: ['FB_PAGE_ID'],
  INSTAGRAM_ACCESS_TOKEN: ['IG_ACCESS_TOKEN', 'INSTAGRAM_TOKEN'],
  INSTAGRAM_USER_ID: ['IG_USER_ID', 'INSTAGRAM_BUSINESS_ID'],
  INSTAGRAM_BUSINESS_ID: ['INSTAGRAM_USER_ID', 'IG_USER_ID'],
  TIKTOK_ACCESS_TOKEN: ['TIKTOK_TOKEN'],
  MASTODON_TOKEN: ['MASTODON_ACCESS_TOKEN'],
  MASTODON_ACCESS_TOKEN: ['MASTODON_TOKEN'],
  LINKEDIN_AUTHOR_URN: ['LINKEDIN_PERSON_URN'],
  SOCIAL_WEBHOOK_URL: ['GENERIC_WEBHOOK_URL', 'WEBHOOK_URL'],
};
...
const FEATURE_GROUPS = {
  ...
  optionalPayments: ['NOWPAYMENTS_API_KEY', 'NOWPAYMENTS_IPN_SECRET', 'PAYPAL_CLIENT_ID', 'PAYPAL_CLIENT_SECRET', 'BTCPAY_SERVER_URL', 'BTCPAY_API_KEY', 'BTCPAY_STORE_ID', 'STRIPE_SECRET_KEY', 'STRIPE_WEBHOOK_SECRET'],
  email: ['RESEND_API_KEY', 'BREVO_API_KEY', 'MAILERSEND_API_KEY', 'SMTP_HOST', 'SMTP_USER', 'SMTP_PASS'],
  observability: ['OTEL_EXPORTER_OTLP_ENDPOINT'],
  vault: ['VAULT_MASTER_SECRET', 'VAULT_EMERGENCY_CODE', 'MASTER_CONFIG_SECRET'],
  socialDistribution: [
    'X_BEARER_TOKEN', 'X_ACCESS_TOKEN', 'TELEGRAM_BOT_TOKEN',
    'PINTEREST_TOKEN', 'DEV_API_KEY', 'YOUTUBE_API_KEY',
    'PRODUCTHUNT_DEVELOPER_TOKEN', 'DISCORD_WEBHOOK_URL',
    'MASTODON_TOKEN', 'BLUESKY_APP_PASSWORD', 'LINKEDIN_ACCESS_TOKEN',
    'FACEBOOK_PAGE_TOKEN', 'FACEBOOK_PAGE_ID',
    'INSTAGRAM_ACCESS_TOKEN', 'INSTAGRAM_USER_ID',
    'TIKTOK_ACCESS_TOKEN', 'THREADS_ACCESS_TOKEN',
    'REDDIT_CLIENT_ID', 'SOCIAL_WEBHOOK_URL',
    'GENERIC_WEBHOOK_URL',
  ],
  dropshipFulfillment: [
    'ZACC_CJ_API_KEY', 'CJ_API_KEY',
    'PRINTFUL_API_TOKEN', 'PRINTFUL_API_KEY', 'PRINTFUL_STORE_ID',
    'PRINTIFY_API_TOKEN', 'PRINTIFY_API_KEY', 'PRINTIFY_SHOP_ID',
    'ZACC_FULFILL_WEBHOOK_URL',
  ],
...
function composeDerivedValues() {
  ...
  if (!configured('LINKEDIN_AUTHOR_URN') && configured('LINKEDIN_ORG_ID')) {
    process.env.LINKEDIN_AUTHOR_URN = 'urn:li:organization:' + String(process.env.LINKEDIN_ORG_ID).trim();
    resolved.LINKEDIN_AUTHOR_URN = 'LINKEDIN_ORG_ID';
  }
  return resolved;
}
