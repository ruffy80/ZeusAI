...
function routeDescription(route) {
  const map = {
    ...
    '/crypto-bridge': 'Crypto Bridge transfer intelligence inside ZeusAI: Fee Lock, Smart Bump, Destination Check, Liquidity Unlock, Atomic Swap, MEV protection, Batch TX, and Time-Locked Refund. Non-custodial, signed fees, instant quotes.',
