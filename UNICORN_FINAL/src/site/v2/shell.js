...
function pageInnovations() {
  ...
  <div class="container">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:14px;margin:22px 0">
      <div class="card" style="padding:18px"><span class="tag">Constitution</span><h3 id="invConHash" style="margin:8px 0;font-family:monospace">…</h3><p style="color:var(--ink-dim);font-size:13.5px">Public, hashed, signed. Every response carries <code class="inline">X-Constitution-Hash</code>.</p><a href="/api-explorer?endpoint=%2Fapi%2Fconstitution" class="btn" style="margin-top:8px">View in API Explorer</a></div>
      <div class="card" style="padding:18px"><span class="tag">Today's Merkle root</span><h3 id="invRoot" style="margin:8px 0;font-family:monospace;font-size:14px">…</h3><p style="color:var(--ink-dim);font-size:13.5px"><span id="invRootCount">0</span> receipts · OP_RETURN-ready · published daily</p><a href="/api-explorer?endpoint=%2Fapi%2Freceipts%2Froot" class="btn" style="margin-top:8px">Open in API Explorer</a></div>
      <div class="card" style="padding:18px"><span class="tag">BTC TWAP (5-source median)</span><h3 id="invTwap" style="margin:8px 0">$…</h3><p style="color:var(--ink-dim);font-size:13.5px">Kraken · Coinbase · Bitstamp · Binance · OKX</p><a href="/api-explorer?endpoint=%2Fapi%2Fbtc%2Ftwap" class="btn" style="margin-top:8px">Open in API Explorer</a></div>
      ...
      <div class="card" style="padding:18px"><span class="tag">Reproducible SBOM</span><h3 id="invSbom" style="margin:8px 0;font-family:monospace;font-size:14px">…</h3><p style="color:var(--ink-dim);font-size:13.5px">sha3-256 over critical sources · public composite hash</p><a href="/api-explorer?endpoint=%2Fapi%2Fsbom" class="btn" style="margin-top:8px">View in API Explorer</a></div>
      <div class="card" style="padding:18px"><span class="tag">Permanent archive manifest</span><h3 style="margin:8px 0">Archive snapshot</h3><p style="color:var(--ink-dim);font-size:13.5px">Daily root + constitution + SBOM + PQ pubkey, ready for Archive.org / Arweave anchoring.</p><a href="/api-explorer?endpoint=%2Fapi%2Finnovations%2Farchive" class="btn" style="margin-top:8px">Open in API Explorer</a></div>
    </div>
    ...
    <p class="lead" style="max-width:880px;font-size:14.5px">15 GET-only deterministic endpoints designed to remain a public web standard for 50+ years. Additive only · 5-year deprecation windows · zero rollback path. <a href="/api-explorer?endpoint=%2Fapi%2Fv100%2Fmanifest">Discovery manifest →</a></p>
    ...
    <p class="lead" style="max-width:880px;font-size:14.5px">15 third-wave contracts that turn zeusai.pro into a public web standard for the next 50 years: semantic stability pact, accessibility equity ledger, cognitive load budget, anti-dark-patterns receipt, data minimization proof, offline-first pledge, time-to-meaningful-content (TTMC), interop contract, content provenance chain (anti-AI-slop), zero-knowledge telemetry, graceful degradation matrix, mobile-parity pact, viewport equity, touch-target equity, battery-impact budget. <a href="/api-explorer?endpoint=%2Fapi%2Fv100%2Fperf%2Fv3%2Fmanifest">v3 manifest →</a></p>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:14px;margin:14px 0 22px">
...
function pageStatus(params = {}) {
  ...
  <div class="card" id="subosPanel" style="margin-top:18px;padding:26px" aria-live="polite">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:16px;flex-wrap:wrap">
      ...
      <a class="btn btn-ghost" href="/api/autonomy/bond" target="_blank" rel="noopener" style="font-size:12px">Bond JSON →</a>
    </div>
