...
function pageAccount() {
  ...
  <div style="max-width:1100px;margin:0 auto;padding:0 28px">
    ...
    <div id="accountRoot">
      <div style="text-align:center;color:var(--ink-dim);font-size:16px;padding:40px 0;">
        To sign in, create an account, or use a device key, use the <b>Sign in</b> button at the top right.
      </div>
    </div>
  </div>
</section>`;
