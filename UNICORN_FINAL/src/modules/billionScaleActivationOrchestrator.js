...
const REQUIRED_CAPABILITIES = [
  {
    ...
    existingModules: ['billion-scale-revenue-engine', 'billing-engine', 'offer-factory', 'unicorn-commerce-connector'],
  ...
  },
  {
    ...
    existingModules: ['autonomousMoneyMachine', 'autoRevenue', 'ai-sdr-agent', 'ai-sales-closer-pro', 'autonomous-bd-engine'],
  ...
  },
  {
    ...
    existingModules: ['quantumPaymentNexus', 'billing-engine', 'tenantBilling', 'paymentGateway'],
  ...
  },
  {
    ...
    existingModules: ['serviceMarketplace', 'universalAITrainingMarketplace', 'referralEngine', 'dynamic-pricing'],
  ...
  },
  {
    ...
    existingModules: ['enterprisePartnership', 'enterprise-deal-desk', 'legalFortress', 'complianceEngine', 'riskAnalyzer'],
  ...
  },
  {
    ...
    existingModules: ['provisioning-engine', 'tenantProvisioning', 'global-api-gateway', 'tenant-manager', 'saas-orchestrator-v4'],
  ...
  },
  {
    ...
    existingModules: ['programmatic-seo-engine', 'seo-optimizer', 'auto-marketing', 'socialMediaViralizer', 'autoViralGrowth'],
