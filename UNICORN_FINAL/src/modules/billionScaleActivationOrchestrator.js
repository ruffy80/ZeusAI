...
const REQUIRED_CAPABILITIES = [
  ...
  },
  {
    ...
    existingModules: ['sovereign-btc-commerce-bridge', 'quantumPaymentNexus', 'billing-engine', 'tenantBilling', 'paymentGateway'],
  ...
  },
  {
    ...
    existingModules: ['serviceMarketplace', 'universalAITrainingMarketplace', 'module-to-marketplace-sync', 'referralEngine', 'dynamic-pricing'],
