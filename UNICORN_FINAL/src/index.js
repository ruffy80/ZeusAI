...
(function(){
  ...
  function hasLiveSupplier(d){if(d.suppliersConfigured===true||d.supplierConfigured===true||d.liveSuppliers===true)return true;var suppliers=d.suppliers||{};if(suppliers.autoShipReady===true||suppliers.cjConfigured===true||suppliers.printfulConfigured===true||suppliers.printifyConfigured===true)return true;if(d.fulfillmentReadiness&&d.fulfillmentReadiness.autoShipReady===true)return true;var uscf=suppliers.uscf||d.uscf;if(uscf&&uscf.autoShipReady===true)return true;var sc=d.scraper||{},configured=sc.configuredSources||d.configuredSources||{};if(Array.isArray(configured))return configured.some(function(x){return x&&x.configured===true;});return Object.keys(configured).some(function(k){return configured[k]===true;});}
