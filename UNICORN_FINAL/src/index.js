...
.ds-hero{position:relative;isolation:isolate;min-height:calc(100svh - 96px);display:grid;align-items:center;overflow-x:hidden;overflow-y:visible;border-bottom:1px solid var(--line);background:#04080d}
