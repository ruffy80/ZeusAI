  ...
  if (urlPath === '/unicorn-cockpit' || urlPath === '/unicorn-status.html' || urlPath === '/revenue-command' || urlPath === '/proof' || urlPath === '/revenue-share' || urlPath === '/zacc' || urlPath === '/dropship' || urlPath.indexOf('/dropship/product/') === 0) {
    const renderPage = (title, bodyHtml, pageScript) => {
      ...
      return [
        ...
        '<a href="/">Home</a><a href="/social-network" style="color:#7cf7c0;font-weight:700">🌍 Social Network</a><a href="/zacc" style="color:#8a5cff;font-weight:700">🛒 Autonomous Dropshipping</a><a href="/dropship" style="color:#8a5cff;font-weight:700">🌐 Live Store</a><a href="/pricing">Pricing</a><a href="/revenue-share">Revenue Share</a><a href="/proof">Proof</a><a href="/unicorn-cockpit">Cockpit</a><a href="/services">Services</a><a href="/status">Status</a>',
        '</div></nav>',
        '</header>',
        '<main>',
    ...
    if (urlPath === '/social-network') {
      ...
      return res.end(renderPage('Social Network', body, js));
    }
