...
function buildInnovationCoverage() {
  ...
  const items = [
    ...
    { id: 'billion-scale-revenue-foundation', title: 'Billion-Scale Revenue Foundation: Packages + Deal Desk + KPI + Marketplace Economics + Profit Path OS', status: 'live-foundation-api', evidence: ['/api/billion-scale/status', '/api/billion-scale/packages', '/api/billion-scale/owner-dashboard', '/api/billion-scale/marketplace-economics', '/api/billion-scale/profit-path', '/api/billion-scale/deal-desk/proposal'], userAction: 'requires real customers, distribution, proof and delivery; infrastructure is live — default economics never invent GMV' },
