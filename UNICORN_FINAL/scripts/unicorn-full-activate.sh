...
TAOS_SAFE_ARM=1
AACOS_DISABLED=0
GROWTH_STACK_DISABLED=0
TRAFFIC_ENGINE_DISABLED=0
RIVOS_DISABLED=0
AGDE_DISABLED=0
TAAC_DISABLED=0
DISABLE_BILLION_AUTONOMY_LOOP=0
BILLION_AUTONOMY_LOOP_FORCE=1
LEAD_HUNTER_FORCE=1
AUTO_MARKETING_FORCE=1
INNOVATION_AUTO_SHIP=0
INNOVATION_GENERATE=0
ADI_CORE_DISABLED=1
ENV
log "wrote safe FULL autonomy env → $AUTONOMY_ENV_FILE"
