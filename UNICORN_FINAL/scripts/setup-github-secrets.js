...
async function run() {
  ...
  const SECRETS = {
    ...
    // HUGGINGFACE_API_KEY este cheia canonică; HF_API_KEY este aliasul legacy.
    // Ambele sunt scrise pentru compatibilitate cu toate modulele AI.
    HUGGINGFACE_API_KEY:  process.env.HUGGINGFACE_API_KEY  || process.env.HF_API_KEY || 'your_huggingface_api_key_here',
    HF_API_KEY:           process.env.HF_API_KEY           || process.env.HUGGINGFACE_API_KEY || 'your_huggingface_api_key_here',
    ...
    ...(process.env.NOWPAYMENTS_API_KEY     ? { NOWPAYMENTS_API_KEY:     process.env.NOWPAYMENTS_API_KEY }     : {}),
    ...(process.env.NOWPAYMENTS_IPN_SECRET  ? { NOWPAYMENTS_IPN_SECRET:  process.env.NOWPAYMENTS_IPN_SECRET }  : {}),
    ...(process.env.NOWPAYMENTS_SANDBOX     ? { NOWPAYMENTS_SANDBOX:     process.env.NOWPAYMENTS_SANDBOX }     : {}),
    ...(process.env.BTCPAY_SERVER_URL       ? { BTCPAY_SERVER_URL:       process.env.BTCPAY_SERVER_URL }       : {}),
    ...(process.env.BTCPAY_API_KEY          ? { BTCPAY_API_KEY:          process.env.BTCPAY_API_KEY }          : {}),
    ...(process.env.BTCPAY_STORE_ID         ? { BTCPAY_STORE_ID:         process.env.BTCPAY_STORE_ID }         : {}),
    ...
    ...(process.env.FACEBOOK_PAGE_TOKEN          ? { FACEBOOK_PAGE_TOKEN:          process.env.FACEBOOK_PAGE_TOKEN }          : {}),
    ...(process.env.FACEBOOK_PAGE_ID             ? { FACEBOOK_PAGE_ID:             process.env.FACEBOOK_PAGE_ID }             : {}),
    ...(process.env.INSTAGRAM_ACCESS_TOKEN       ? { INSTAGRAM_ACCESS_TOKEN:       process.env.INSTAGRAM_ACCESS_TOKEN }       : {}),
    ...(process.env.INSTAGRAM_USER_ID            ? { INSTAGRAM_USER_ID:            process.env.INSTAGRAM_USER_ID }            : {}),
    ...(process.env.TIKTOK_ACCESS_TOKEN          ? { TIKTOK_ACCESS_TOKEN:          process.env.TIKTOK_ACCESS_TOKEN }          : {}),
    ...(process.env.THREADS_ACCESS_TOKEN         ? { THREADS_ACCESS_TOKEN:         process.env.THREADS_ACCESS_TOKEN }         : {}),
    ...(process.env.DISCORD_WEBHOOK_URL          ? { DISCORD_WEBHOOK_URL:          process.env.DISCORD_WEBHOOK_URL }          : {}),
    ...(process.env.LINKEDIN_ACCESS_TOKEN        ? { LINKEDIN_ACCESS_TOKEN:        process.env.LINKEDIN_ACCESS_TOKEN }        : {}),
    ...(process.env.LINKEDIN_AUTHOR_URN          ? { LINKEDIN_AUTHOR_URN:          process.env.LINKEDIN_AUTHOR_URN }          : {}),
    ...(process.env.LINKEDIN_ORG_ID              ? { LINKEDIN_ORG_ID:              process.env.LINKEDIN_ORG_ID }              : {}),
    ...(process.env.BLUESKY_HANDLE               ? { BLUESKY_HANDLE:               process.env.BLUESKY_HANDLE }               : {}),
    ...(process.env.BLUESKY_APP_PASSWORD         ? { BLUESKY_APP_PASSWORD:         process.env.BLUESKY_APP_PASSWORD }         : {}),
    ...(process.env.MASTODON_TOKEN               ? { MASTODON_TOKEN:               process.env.MASTODON_TOKEN }               : {}),
    ...(process.env.SOCIAL_WEBHOOK_URL           ? { SOCIAL_WEBHOOK_URL:           process.env.SOCIAL_WEBHOOK_URL }           : {}),
