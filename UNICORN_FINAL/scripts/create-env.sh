...
upsert ZEUS_TG_GROUP_CHAT_ID      "${ZEUS_TG_GROUP_CHAT_ID:-}"
upsert TELEGRAM_GROUP_CHAT_ID     "${TELEGRAM_GROUP_CHAT_ID:-}"
upsert X_BEARER_TOKEN             "${X_BEARER_TOKEN:-}"
upsert X_ACCESS_TOKEN             "${X_ACCESS_TOKEN:-}"
upsert X_ACCESS_SECRET            "${X_ACCESS_SECRET:-}"
upsert X_API_KEY                  "${X_API_KEY:-}"
upsert X_API_SECRET               "${X_API_SECRET:-}"
...
upsert DISCORD_WEBHOOK_URL        "${DISCORD_WEBHOOK_URL:-}"
upsert DISCORD_WEBHOOK            "${DISCORD_WEBHOOK:-}"
upsert MASTODON_INSTANCE          "${MASTODON_INSTANCE:-}"
upsert MASTODON_TOKEN             "${MASTODON_TOKEN:-}"
upsert BLUESKY_HANDLE             "${BLUESKY_HANDLE:-}"
upsert BLUESKY_APP_PASSWORD       "${BLUESKY_APP_PASSWORD:-}"
upsert LINKEDIN_ACCESS_TOKEN      "${LINKEDIN_ACCESS_TOKEN:-}"
upsert LINKEDIN_AUTHOR_URN        "${LINKEDIN_AUTHOR_URN:-}"
upsert LINKEDIN_ORG_ID            "${LINKEDIN_ORG_ID:-}"
upsert FACEBOOK_PAGE_TOKEN        "${FACEBOOK_PAGE_TOKEN:-}"
upsert FACEBOOK_PAGE_ID           "${FACEBOOK_PAGE_ID:-}"
upsert FACEBOOK_ACCESS_TOKEN      "${FACEBOOK_ACCESS_TOKEN:-}"
upsert INSTAGRAM_ACCESS_TOKEN     "${INSTAGRAM_ACCESS_TOKEN:-}"
upsert INSTAGRAM_USER_ID          "${INSTAGRAM_USER_ID:-}"
upsert TIKTOK_ACCESS_TOKEN        "${TIKTOK_ACCESS_TOKEN:-}"
upsert TIKTOK_CLIENT_KEY          "${TIKTOK_CLIENT_KEY:-}"
upsert TIKTOK_CLIENT_SECRET       "${TIKTOK_CLIENT_SECRET:-}"
upsert THREADS_ACCESS_TOKEN       "${THREADS_ACCESS_TOKEN:-}"
upsert THREADS_USER_ID            "${THREADS_USER_ID:-}"
upsert REDDIT_CLIENT_ID           "${REDDIT_CLIENT_ID:-}"
upsert REDDIT_CLIENT_SECRET       "${REDDIT_CLIENT_SECRET:-}"
upsert REDDIT_USERNAME            "${REDDIT_USERNAME:-}"
upsert REDDIT_PASSWORD            "${REDDIT_PASSWORD:-}"
upsert REDDIT_SUBREDDIT           "${REDDIT_SUBREDDIT:-}"
upsert SOCIAL_WEBHOOK_URL         "${SOCIAL_WEBHOOK_URL:-}"
