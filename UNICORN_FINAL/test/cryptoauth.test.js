...
assert(shellJs.includes('zeus-login-v1'), 'shell.js signs zeus-login-v1 messages');
assert(shellJs.includes('zeus-recover-v1'), 'shell.js signs zeus-recover-v1 messages');
