...
assert(/brand-176\.jpg[^<]*width="72"[^<]*height="72"[^<]*(fetchpriority="high"|loading="lazy")/.test(shellJs), 'brand logo has explicit dimensions + high-priority (above-fold) loading');
