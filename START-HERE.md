...
### 🤖 Automation Module
**github-hetzner-connector.js** (12 KB)
- `GitHubAutoConnector` - Create repos, add secrets, setup webhooks
- `HetznerAutoLinker` - Create projects, link GitHub, auto-deploy
...
2. **GITHUB-HETZNER-HETZNER-CONNECTOR.md** (9.5 KB)
...
| **GITHUB-HETZNER-HETZNER-CONNECTOR.md** | Technical details & API | 9.5 KB |
...
2. Collect credentials (GitHub, Hetzner, Hetzner)
...
### Problem: Hetzner Not Deploying  
→ Check GitHub Actions tab for build logs

### Problem: App Not Restarting
→ SSH into Hetzner: `pm2 logs webhook-server`

**See full troubleshooting:** IMPLEMENTATION-GUIDE.md or GITHUB-HETZNER-HETZNER-CONNECTOR.md
...
4. **Check logs:**
   ...
   - Hetzner: https://hetzner.com/dashboard
...
- [ ] Hetzner project created and linked
...
- **API Reference** - In GITHUB-HETZNER-HETZNER-CONNECTOR.md
...
✅ GITHUB-HETZNER-HETZNER-CONNECTOR.md (9.5 KB)
