...
5. Deploy!
   ...
   → Automatic deployment through GitHub + Hetzner flow
...
SETUP-HETZNER-GUIDE.md ← DEPLOYMENT REFERENCE
   ✅ Provisioning flow
   ✅ Runtime checks
   ✅ Health verification
   ✅ Recovery hints
...
2. Use a staging Hetzner host first:
   HETZNER_HOST_GERMANY for staging, different for production
...
6. Rollback quickly:
   ...
   Hetzner: snapshot/restore from console
